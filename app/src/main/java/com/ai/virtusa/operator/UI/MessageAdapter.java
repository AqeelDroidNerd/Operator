package  com.ai.virtusa.operator.UI;
...
import com.ai.virtusa.operator.R;
import com.ai.virtusa.operator.User;
import com.ai.virtusa.operator.Utility;
...
public class MessageAdapter extends BaseAdapter{
    ...
    @Override
    public int getCount() {
        return user.messages.size();
    }
    @Override
    public Object getItem(int position) {
        return user.messages.get(position);
    }
    @Override
